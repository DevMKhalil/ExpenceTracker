---
name: speckit-fix
description: "Apply fixes from a SpecKit Review Report (review.md) to implementation source code. Mechanically follows fix instructions from the review agent. Use after speckit.review identifies issues."
