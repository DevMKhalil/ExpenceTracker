...
description: "Apply fixes from a SpecKit Analysis Report to spec.md, plan.md, and tasks.md. Use after speckit.analyze identifies issues to automatically remediate findings by editing spec artifacts directly."
